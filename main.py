...
TILE_SCALING = 0.5
CHARACTER_SCALING = TILE_SCALING * 1.8
COIN_SCALING = TILE_SCALING
SPRITE_PIXEL_SIZE = 128
GRID_PIXEL_SIZE = SPRITE_PIXEL_SIZE * TILE_SCALING

# Shooting Constants
SPRITE_SCALING_LASER = 0.9
SHOOT_SPEED = 1
BULLET_SPEED = 10
BULLET_DAMAGE = 15
...
class Enemy(Entity):
    ...
    def update_animation(self, delta_time: float = 1 / 45):
...
class MainMenu(arcade.View):
    ...
    def on_draw(self):
        ...
        arcade.draw_text("Shoot all the enemies!",
                         585,
                         300,
                         arcade.color.RED,
                         25,
                         anchor_x="center")
        arcade.draw_text("** Q to shoot",
                         585,
                         270,
                         arcade.color.BLACK,
                         20,
...
class GameView(arcade.View):
    ...
    def on_draw(self):
        ...
        score_text = f"Point Achieved: {self.score}"
        arcade.draw_text(
            score_text,
            30,
            700,
